...
const rankEvent = (correlation, eventById, candidateById) => {
  ...
  // Signal strength answers "what deserves investigation?".
  // It is intentionally NOT presented as editorial value or publication readiness.
  const signal = avg([emerging, convergence, confidence, timeliness, independence]);
